...
def xls_read(file: object) -> List[Dict]:
    """
    Convert xls file to list of dicts
    :param file: object
    :return: list
    """
...
def csv_read(file: object) -> List[Dict]:
    """
    Convert csv file to list of dicts
    # :param file: object
    :return: list
    """
    rows_list = list(csv.reader(codecs.iterdecode(file, "utf-8")))
